...
export const UserInfoComponent = async({ userInfo, ownsProfile }: { userInfo: userObject, ownsProfile: boolean }) => {
  ...
  return (
    <MultipleRowsWrapper>
        <div className="
          lg:relative w-full lg:flex lg:flex-col lg:h-full">
          <section className="
            lg:place-self-end lg:sticky lg:top-[15vh]
            grid md:grid-cols-2 gap-x-2 gap-y-4 min-h-[250px]">
      ...
      <section className="max-w-xl lg:place-self-start">
        <h1>Latest Posts</h1>
        <ul className="mt-2">
